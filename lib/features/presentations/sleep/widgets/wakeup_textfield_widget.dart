...
class WakeUpTextFieldWidget extends StatelessWidget {
  const WakeUpTextFieldWidget({
    super.key,
    required this.cubit,
  });
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      readOnly: true,
      controller: cubit.wakeUpTextController,
